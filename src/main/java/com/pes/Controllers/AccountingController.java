...
import com.pes.dao.StudentFeeRecordRepo;
...
public class AccountingController {
	...
	public String dashboard(Model model) {
		...
		model.addAttribute("grossIncome",
				grossIncome + totalProductPrice + totalBusMaintenance + totalSemesterFee + totalRegistrationFee);
		model.addAttribute("netIcome",
				(netIcome + totalRegistrationFee + totalSemesterFee) - totalProductPrice - totalBusMaintenance);
	...
	public String balanceSheetSearch(Model model, @RequestParam("startDate") Date startDate,
	...
	public String trailSheetSearch(Model model, @RequestParam("startDate") Date startDate,
			@RequestParam("endDate") Date endDate) {
