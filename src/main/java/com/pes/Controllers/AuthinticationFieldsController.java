...
import com.pes.dao.StudentFeedbackRepo;
import com.pes.dao.SubjectRepo;
import com.pes.dao.UserRepository;
import com.pes.entities.pes_student_rem;
import com.pes.entities.Subject;
...
public class AuthinticationFieldsController {
	...
	public String home(Model model, @RequestParam(value = "page", defaultValue = "0") int page) {
		...
		List<pes_student_rem> studentFeedbackList = this.studentFeedback.findAll();
	...
	public String studentFeedback(Model model, pes_student_rem studentFeedback) {
		model.addAttribute("title", "Home");
