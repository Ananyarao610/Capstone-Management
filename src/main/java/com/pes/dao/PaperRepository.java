...
public interface PaperRepository extends CrudRepository<ResultList, Integer>, JpaRepository<ResultList, Integer> {
	...
	public List<ResultList> getAllRsultListBySemesterAndBatch(@Param("semester") String semester,
	...
	public ResultList getAllRsultListBySemesterAndBatchForPaperChecking(@Param("semester") String semester,
			@Param("batch") String batch, @Param("rollNo") String rollNo, @Param("paperName") String paperName);
	...
	public Page<ResultList> getAllRsultListByPage(Pageable pageable, @Param(value = "batch") String batch,
	...
	Float selectTotalsGradPoints(@Param(value = "rollNo") String rollNo, @Param(value = "semester") String semester,
	...
	Float selectTotalsGradPointsBySemester(@Param(value = "rollNo") String rollNo, @Param(value = "batch") String batch,
			@Param(value = "semester") String semester);

	// SearchAlgorithm
	// @Query("SELECT * FROM ResultList WHERE rollNo LIKE :rollNo")
	public List<ResultList> findByStudentNameContainingAndSemesterAndBatch(String StudentName, String semester,
			String batch);
	...
	public int updatePaperMarks(@Param(value = "id") int id, @Param(value = "marks") int marks,
			@Param(value = "gp") float gp, @Param(value = "value") float value);
