...
public class research_paper {
	...
	public research_paper(int id, String title, int quantity, String availibile, String edition, String autherName,
			String department) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Book [id=" + id + ", title=" + title + ", quantity=" + quantity + ", availibile=" + availibile
				+ ", edition="
